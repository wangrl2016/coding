 ...
 *
 * We use a one based array to simplify parent and child calculation.
 *
 ...
 * The insert and delete-the-minimum operations take O(logn) amortized(平摊) time, where
 * n is the number of elements in the priority queue. This is an amortized bound
 * (and not a worst-case bound) because of array resizing operations.
 * The min, size, and isEmpty operations take O(1) time in the worst case.
